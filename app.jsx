...
const NET_WORTH = [
148200, 150100, 149800, 152400, 154900, 153700, 157200, 159800,
161300, 160200, 163900, 166400, 168100, 167500, 170900, 173200,
175800, 174600, 178300, 180900, 182100, 181400, 183900, 185381];
...
const CASHFLOW = [
{ m: "Jan", in: 6100, out: 4300 },
{ m: "Feb", in: 6250, out: 3980 },
{ m: "Mar", in: 6200, out: 4520 },
{ m: "Apr", in: 6420, out: 4185 },
{ m: "May", in: 6300, out: 4410 },
{ m: "Jun", in: 6420, out: 4185 }];


const CATEGORIES = [
{ name: "Housing", spent: 1650, budget: 1700, color: "#c0763e" },
{ name: "Groceries", spent: 612, budget: 700, color: "#7a9a52" },
{ name: "Dining", spent: 385, budget: 300, color: "#cf6b3f" },
{ name: "Transport", spent: 208, budget: 300, color: "#5a93a8" },
{ name: "Shopping", spent: 421, budget: 400, color: "#b06a8c" },
{ name: "Utilities", spent: 244, budget: 260, color: "#9a8048" }];


const TXNS = [
{ name: "Whole Foods Market", cat: "Groceries", amt: -84.20, when: "Today", icon: "cart" },
{ name: "Monthly paycheck", cat: "Income", amt: 3210.00, when: "Today", icon: "income" },
{ name: "Spotify", cat: "Subscriptions", amt: -11.99, when: "Yesterday", icon: "music" },
{ name: "Shell", cat: "Transport", amt: -52.40, when: "Jun 10", icon: "fuel" },
{ name: "Blue Bottle Coffee", cat: "Dining", amt: -6.80, when: "Jun 10", icon: "coffee" },
{ name: "Amazon", cat: "Shopping", amt: -129.30, when: "Jun 9", icon: "bag" }];


const GOALS = [
{ name: "Emergency fund", emoji: "\uD83C\uDFE6", have: 28640, target: 30000 },
{ name: "Japan trip", emoji: "\u2708\uFE0F", have: 2100, target: 5000 },
{ name: "New laptop", emoji: "\uD83D\uDCBB", have: 900, target: 2200 }];


const ACCOUNTS = [
{ type: "Checking", name: "Everyday", bal: 4280.55, icon: "bank" },
{ type: "Savings", name: "Emergency", bal: 28640.00, icon: "piggy" },
{ type: "Brokerage", name: "Investments", bal: 61300.40, icon: "chart" },
{ type: "Retirement", name: "401(k)", bal: 92400.00, icon: "shield" },
{ type: "Credit", name: "Visa", bal: -1240.30, icon: "card" }];


/* ---------------------------------- Accounts page data ---- */
const ACCOUNT_GROUPS = [
{ label: "Cash", accounts: [
  { name: "Everyday Checking", inst: "Chase", mask: "4280", bal: 4280.55, icon: "bank", chg: 312.40, trend: [3850, 4020, 3760, 4310, 4180, 3990, 4205, 4281] },
  { name: "Emergency Savings", inst: "Ally Bank", mask: "8821", bal: 28640.00, icon: "piggy", apy: "4.20% APY", chg: 96.10, trend: [27400, 27680, 27920, 28140, 28310, 28460, 28560, 28640] },
  { name: "Joint Checking", inst: "Chase", mask: "5567", bal: 2150.20, icon: "bank", chg: -180.00, trend: [2630, 2540, 2480, 2390, 2330, 2280, 2210, 2150] }] },

{ label: "Investments", accounts: [
  { name: "Brokerage", inst: "Fidelity", mask: "1190", bal: 61300.40, icon: "chart", chg: 1840.20, trend: [56200, 57100, 56800, 58400, 59300, 58900, 60400, 61300] },
  { name: "401(k)", inst: "Vanguard", mask: "7745", bal: 92400.00, icon: "shield", chg: 2310.00, trend: [84200, 85900, 87100, 86400, 88800, 89600, 91200, 92400] },
  { name: "Roth IRA", inst: "Fidelity", mask: "3320", bal: 18250.75, icon: "chart", chg: 420.50, trend: [16900, 17200, 17050, 17480, 17720, 17910, 18080, 18251] }] },

{ label: "Credit", accounts: [
  { name: "Sapphire Visa", inst: "Chase", mask: "0041", bal: -1240.30, icon: "card", chg: -340.20, trend: [-820, -680, -940, -1080, -760, -1190, -1340, -1240] }] }];
...
const ALL_TXNS = [
{ name: "Monthly paycheck", cat: "Income", amt: 3210.00, day: "Today", account: "Everyday Checking", icon: "income" },
{ name: "SQ *THE COFFEE BAR", cat: "Dining", amt: -7.25, day: "Today", account: "Sapphire Visa", icon: "coffee", review: true, reason: "New merchant \u2014 confirm the category" },
{ name: "POS PURCHASE 4471", cat: "Shopping", amt: -43.10, day: "Yesterday", account: "Everyday Checking", icon: "bag", review: true, reason: "Category guessed from amount" },
{ name: "INTERAC e-Transfer", cat: "Income", amt: 120.00, day: "Jun 10", account: "Everyday Checking", icon: "income", review: true, reason: "Uncategorized deposit" },
{ name: "Whole Foods Market", cat: "Groceries", amt: -84.20, day: "Today", account: "Everyday Checking", icon: "cart" },
{ name: "Spotify", cat: "Subscriptions", amt: -11.99, day: "Yesterday", account: "Sapphire Visa", icon: "music" },
{ name: "Trader Joe's", cat: "Groceries", amt: -52.18, day: "Yesterday", account: "Everyday Checking", icon: "cart" },
{ name: "Blue Bottle Coffee", cat: "Dining", amt: -6.80, day: "Yesterday", account: "Sapphire Visa", icon: "coffee" },
{ name: "Shell", cat: "Transport", amt: -52.40, day: "Jun 10", account: "Sapphire Visa", icon: "fuel" },
{ name: "Amazon", cat: "Shopping", amt: -129.30, day: "Jun 10", account: "Sapphire Visa", icon: "bag" },
{ name: "Uber", cat: "Transport", amt: -18.65, day: "Jun 9", account: "Sapphire Visa", icon: "fuel" },
{ name: "Chipotle", cat: "Dining", amt: -14.40, day: "Jun 9", account: "Sapphire Visa", icon: "coffee" },
{ name: "Con Edison", cat: "Utilities", amt: -128.40, day: "Jun 7", account: "Everyday Checking", icon: "bag" },
{ name: "Costco", cat: "Groceries", amt: -212.84, day: "Jun 7", account: "Everyday Checking", icon: "cart" },
{ name: "Netflix", cat: "Subscriptions", amt: -15.49, day: "Jun 5", account: "Sapphire Visa", icon: "music" },
{ name: "Freelance project", cat: "Income", amt: 850.00, day: "Jun 5", account: "Everyday Checking", icon: "income" },
{ name: "Zara", cat: "Shopping", amt: -96.00, day: "Jun 4", account: "Sapphire Visa", icon: "bag" },
{ name: "Sweetgreen", cat: "Dining", amt: -16.25, day: "Jun 3", account: "Sapphire Visa", icon: "coffee" },
{ name: "Rent — Park Ave", cat: "Housing", amt: -1650.00, day: "Jun 1", account: "Everyday Checking", icon: "bank" },
{ name: "Verizon", cat: "Utilities", amt: -80.00, day: "Jun 1", account: "Everyday Checking", icon: "bag", review: true, reason: "Category guessed from merchant" },
{ name: "Equinox", cat: "Subscriptions", amt: -38.00, day: "Jun 1", account: "Sapphire Visa", icon: "music" }];
...
function CashFlowPage() {
  const { Segmented } = DS;
  const periods = Object.keys(CF_FLOW);
  const [per, setPer] = useState(periods[0]);
  const flow = CF_FLOW[per];
    ...
    <React.Fragment>
      <div className="kpi-row">
        ...
        <Card widget><div className="kpi">
          ...
          <span className="kpi-delta" style={{ color: "var(--muted)" }}>across 6 categories</span>
        </div></Card>
        <Card widget><div className="kpi">
      ...
      <Card widget>
        ...
        <Sankey income={flow.income} out={flow.out} monthLabel={per === "Last month" ? "May" : per === "3-mo avg" ? "" : "Jun"} />
    ...
    <div className="user-wrap" ref={ref}>
      ...
      <div className="user-menu" role="menu">
        <div className="user-menu-head">
          <span className="avatar" style={{ background: "var(--accent)", color: "var(--accent-contrast)" }}>A</span>
          <div className="umh-id">
            <div className="umh-name">Avery Brooks</div>
            <div className="umh-mail">avery@hey.com</div>
          </div>
        </div>
        ...
        <div className="user-menu-foot">
          <button className="um-item danger" role="menuitem"><Icon name="logout" />Sign out</button>
        </div>
      </div>
      }
      <button className={"user-btn " + (open ? "open" : "")} onClick={() => setOpen((o) => !o)} aria-haspopup="menu" aria-expanded={open}>
        <span className="avatar" style={{ background: "var(--accent)", color: "var(--accent-contrast)" }}>A</span>
        <span className="user-name">Avery Brooks<span className="user-sub">avery@hey.com</span></span>
...
function SettingsModal({ t, setTweak, onClose, currency, setCurrency, cycleStart, setCycleStart }) {
  ...
  const [email, setEmail] = useState("avery@hey.com");
    ...
    <div className="set-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="set-modal" role="dialog" aria-modal="true" aria-label="Settings">
        ...
        <div className="set-foot">
          <span className="set-note">Changes are saved to this device.</span>
...
function App() {
  ...
  // investments
  const [holdings, setHoldings] = useState(INV_SEED);
  ...
  const saveHolding = (h) => { setHoldings((p) => p.some((x) => x.id === h.id) ? p.map((x) => x.id === h.id ? h : x) : [...p, h]); setInvModal(null); };
  const deleteHolding = (id) => { setHoldings((p) => p.filter((x) => x.id !== id)); setHoldingOpen((cur) => cur === id ? null : cur); };
  ...
  const nwData = NET_WORTH.slice(-PERIODS[period]);
  const nwLabels = MONTH_LABELS.slice(-PERIODS[period]);
  const nwDelta = NET_WORTH[NET_WORTH.length - 1] - NET_WORTH[NET_WORTH.length - 2];
  const nwPct = nwDelta / NET_WORTH[NET_WORTH.length - 2] * 100;

  const income = 6420,spending = 4185,budget = 4600;
  ...
  return (
    <div className="app">
      ...
      <div className="main">
        <div className="main-inner">
          <header className="page-head">
            ...
            <div>
              <h1>{tab === "Dashboard" ? "Welcome back, Avery" : tab}</h1>
              {tab === "Dashboard" && <p className="page-sub">Friday, June 13 · Here's where your money stands today.</p>}
            ...
            <div className="head-actions">
              ...
              {!openAcct && !openHolding && (t.insightsPlacement === "bell" || t.insightsPlacement === "labeled") &&
              ...
              <div className="dash-grid">
                  ...
                  <div className="widget-head">
                    <div>
                      ...
                      <div className="nw-headline">
                        <span className="nw-value">{money(NET_WORTH[NET_WORTH.length - 1])}</span>
                ...
                <Card widget className="span6">
                  <div className="widget-head">
                    ...
                    <span className="muted">5 connected · synced 2h ago</span>
                  </div>
          ...
          tab === "Accounts" ?
          (openAcct ?
            <AccountDetailPage acct={openAcct} onDelete={() => { setDeletedAccts((d) => [...d, openAcct.name]); setAcctOpen(null); }} /> :
            <AccountsPage onOpen={setAcctOpen} deleted={deletedAccts} added={addedAccts} iconOv={acctIconOv} onSetIcon={(name, n) => setAcctIconOv((p) => ({ ...p, [name]: n }))} />) :

          tab === "Transactions" ?
          <TransactionsPage added={addedTxns} removed={removedTxns} catOverrides={catOverrides} iconOverrides={iconOverrides} onUpload={(mode) => setImportOpen(mode || "Statement")} onRemove={(id) => setRemovedTxns((p) => p.includes(id) ? p : [...p, id])} onRecat={(id, c) => setCatOverrides((p) => ({ ...p, [id]: c }))} onSetIcon={(id, n) => setIconOverrides((p) => ({ ...p, [id]: n }))} /> :
      ...
      {/* ---- Add account ---- */}
      {addOpen && <AddAccountModal onClose={() => setAddOpen(false)} onAdd={(a) => { setAddedAccts((p) => [...p, a]); setAddOpen(false); }} />}

      {/* ---- Add transaction ---- */}
      {addTxnOpen && <AddTransactionModal accounts={acctNames} onClose={() => setAddTxnOpen(false)} onAdd={(x) => { setAddedTxns((p) => [{ ...x, id: "a" + Date.now() }, ...p]); setAddTxnOpen(false); }} />}

      {/* ---- Import statements / receipts ---- */}
      {importOpen && <ImportModal accounts={acctNames} initialMode={importOpen} onClose={() => setImportOpen(null)} onImport={(items) => { setAddedTxns((p) => [...items.map((x, i) => ({ ...x, id: "i" + Date.now() + "_" + i })), ...p]); setImportOpen(null); }} />}
