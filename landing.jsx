...
function AuthPanel({ headline }) {
  ...
  const set = (k) => (e) => { setVals(v => ({ ...v, [k]: e.target.value })); setErrs(er => ({ ...er, [k]: null })); setDone(null); };
  ...
  const submit = (e) => {
    ...
    if (Object.keys(er).length === 0) {
      setDone(isReg ? "Account created — taking you to your dashboard…" : "Welcome back — signing you in…");
    }
  };
  ...
  return (
    <div className="auth">
      ...
      <button type="button" className="gbtn" onClick={() => setDone("Continuing with Google…")}>
      ...
      <form className="form" onSubmit={submit} noValidate>
        ...
        <Button variant="primary" type="submit">{isReg ? "Create account" : "Sign in"}</Button>
      </form>
      ...
      <p className="auth-legal">
        By continuing you agree to Claud's <a href="Claud - Legal.html#terms">Terms</a> and <a href="Claud - Legal.html#privacy">Privacy Policy</a>.
      </p>
    </div>
  );
}
      ...
      <div className={`lp ${t.layout === "stacked" ? "stacked" : ""}`}>
        ...
        <section className="lp-left">
          ...
          <div className="lp-left-foot">
            ...
            <a href="Claud - Legal.html#privacy">Privacy</a>
            <a href="Claud - Legal.html#terms">Terms</a>
            <a href="Claud - Legal.html#security">Security</a>
          </div>
        </section>
